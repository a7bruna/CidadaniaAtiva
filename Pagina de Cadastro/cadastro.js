...
function loginUser (login, senha) {
    ...
    for (var i = 0; i < db_usuarios.usuarios.length; i++) {
        ...
        if (login == usuario.login && senha == usuario.senha) {
            ...
            usuarioCorrente.NContato = usuario.NContato;
            ...
            usuarioCorrente.tusuario = usuario.tusuario;
...
function addUser (nome, login, senha, email, NContato, cpf, endereco, numero, bairro, cep, cidade, estado, tusuario) {
    
    // Cria um objeto de usuario para o novo usuario 
    let newId = generateUUID ();
    let usuario = { "id": newId, "login": login, "senha": senha, "nome": nome, "email": email, "NContato": NContato, "cpf": cpf, "endereco": endereco, "numero": numero, "bairro": bairro, "cep": cep, "cidade": cidade, "estado": estado, "tusuario": tusuario };
